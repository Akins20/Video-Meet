...
const validateRequiredEnvVars = (): void => {
  ...
  if (
    ...
    "your-refresh-token-secret-change-this-too"
  ) {
    throw new Error(
      "Please change the default JWT_REFRESH_SECRET in your .env file"
    );
  }
};
...
const config: Config = {
  ...
  database: {
    ...
    testUri:
      ...
      "mongodb://localhost:27017/videomeet-test",
  },
  ...
  upload: {
    ...
    allowedTypes: parseArrayEnv(process.env.ALLOWED_FILE_TYPES, [
      "jpg",
      "jpeg",
      "png",
      "pdf",
